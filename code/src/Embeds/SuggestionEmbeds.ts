...
Deze post wordt om die reden gesloten. Neem contact op met een moderator als dit niet klopt.`);
    ...
    public static GetAppreciatedTagEmbed() {
        ...
        embed.setDescription(`Deze suggestie heeft veel <:upvote:${EmojiConstants.VOTE.UPVOTE}> ontvangen, maar heeft nog valide art nodig om genomineerd te worden.`);
    ...
    public static GetDeniedTagEmbed() {
        ...
        embed.setDescription(`Deze suggestie heeft veel <:downvote:${EmojiConstants.VOTE.DOWNVOTE}> ontvangen, en daarom wordt deze thread nu gesloten.`);
