...
export default class OnboardingEmbeds {
    ...
    public static GetPlacerEmbed() {
        const embed = new EmbedBuilder()
            ...
            .setDescription(`**Autoplacer**\nGa naar <#1131336871373451304> om een uitleg te krijgen over over hoe je onze Autoplacer installeert. Hiermee plaats je automatisch pixels op de juiste plek!\n-------------\n\n${LanguageLoader.LangConfig.ONBOARDING_YOU_CAN_HELP_IN_THE_FOLLOWING_WAYS}:`)
            .addFields(
                {
